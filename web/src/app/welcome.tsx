      ...
      <div>
        <div className="max-w-6xl min-h-[686px] grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-8">
          <div className="order-2 md:order-1 flex items-center">
            <div className="w-full">
              ...
              <div className="text-zeta-grey-400 text-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Link
            ...
            target="_blank"
            className="border border-zeta-grey-200 px-6 py-8 flex gap-4 rounded-lg hover:shadow-zeta-xl hover:border-transparent transition-all active:shadow-none active:border-zeta-grey-200 active:opacity-75"
          >
            <div>
            ...
            <div className="grow">
              ...
              <div className="leading-tight text-zeta-grey-400">
          ...
          >
            ...
            <div className="grow">
              <div className="text-2xl font-medium leading-tight">Discord</div>
              <div className="leading-tight text-zeta-grey-400">
